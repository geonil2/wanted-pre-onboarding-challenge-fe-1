          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col text-slate-700 mt-2">
              ...
              <input
                ...
                name="selectedToDoList"
                disabled={isDisabled}
                value={selectedToDoList.content}
                onChange={handleNewToDoList}
            ...
            <div className="mt-2">
              ...
              <button onClick={handleClickResetButton}>
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <button
                // onClick={() => dispatch(ToDoService.updateToDo({ ...selectedToDoList, id: data.id }))}
                className="w-[49%] pointer-events-auto rounded-md text-center font-medium shadow-sm ring-1 ring-slate-700/10 py-2 px-4 mt-4 hover:bg-slate-50"
              >Update
              </button>
            </div>
...
export default SelectedToDoListForm;
